...
//    int indexing=0;
    ...
    public ArrayList<String> department_listing=new ArrayList<String>();
    public CardView cv;
...
//        mRecyclerView.setHasFixedSize(true);
        ...
        view=inflater.inflate(R.layout.fragment_departmentlist, container, false);
...
//                    myValues1.add(year);
                ...
                for( String arr:department_listing)
                {

                    departmentNames.add(arr);
                    department_listing.clear();
                }
...
//                }
               ...
               // LinearLayoutManager linearLayoutManager = new LinearLayoutManager(getActivity());
                ...
                CustomAdapterForDepartment customAdapterForDepartment = new CustomAdapterForDepartment(getActivity(), departmentNames);
                recyclerView.setAdapter(customAdapterForDepartment); // set the Adapter to RecyclerView
...
//            txt2=(TextView)view.findViewById(R.id.textView2);
       ...
       getActivity().setTitle("Department List");
