...
public class PhoneAuthActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(is_NET_Connected(PhoneAuthActivity.this))
        {
        ...
        {
            Toast.makeText(PhoneAuthActivity.this,"No Internet Connection Available",Toast.LENGTH_SHORT).show();
            finish();
        }
        ...
        edt1.addTextChangedListener(new PhoneAuthActivity.GenericTextWatcher(edt1));
        edt2 = (EditText) findViewById(R.id.edt2);
        edt2.addTextChangedListener(new PhoneAuthActivity.GenericTextWatcher(edt2));
        edt3 = (EditText) findViewById(R.id.edt3);
        edt3.addTextChangedListener(new PhoneAuthActivity.GenericTextWatcher(edt3));
        edt4 = (EditText) findViewById(R.id.edt4);
        edt4.addTextChangedListener(new PhoneAuthActivity.GenericTextWatcher(edt4));
        edt5 = (EditText) findViewById(R.id.edt5);
        edt5.addTextChangedListener(new PhoneAuthActivity.GenericTextWatcher(edt5));
        edt6 = (EditText) findViewById(R.id.edt6);
        edt6.addTextChangedListener(new PhoneAuthActivity.GenericTextWatcher(edt6));
        ...
        mCallbacks = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            public void onVerificationCompleted(PhoneAuthCredential phoneAuthCredential) {
                Toast.makeText(PhoneAuthActivity.this, "verification done" + phoneAuthCredential, Toast.LENGTH_LONG).show();
            }
            ...
            public void onCodeSent(String verificationId,
                ...
                Toast.makeText(PhoneAuthActivity.this, "Verification code sent to mobile", Toast.LENGTH_LONG).show();
        ...
        OTPButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (edt1.getText().toString().trim().length() == 0)
                    ...
                    //  Toast.makeText(PhoneAuthActivity.this, OTP + "", Toast.LENGTH_SHORT).show();
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            // ...
                            finish();
                            startActivity(new Intent(PhoneAuthActivity.this, DashboardActivity.class));
